    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h4 class="header-title">{{ __('product.lbl_create') }}</h4>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="lbl_name">{{ __('product.lbl_name') }}
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="name" id="lbl_name" class="form-control"
                                        value="{{ old('name') }}" placeholder="{{ __('product.lbl_name') }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="lbl_price">{{ __('product.lbl_price') }}</label>
                                    <input type="number" name="price" id="lbl_price" min="0" class="form-control"
                                        value="{{ old('price') }}" placeholder="{{ __('product.lbl_price') }}">
                                    @error('icon')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
