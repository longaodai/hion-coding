    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h4 class="header-title">{{ __('category.lbl_edit') }}</h4>
                    </div>
                    <hr>
                    <form method="POST" action="{{ route('admin.category.update', ['id' => $data->id]) }}">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="lbl_name" class="form-control"
                                        ...
                                        placeholder="{{ __('category.lbl_name') }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="icon" id="lbl_icon" class="form-control"
                                        ...
                                        placeholder="{{ __('common.lbl_icon') }}">
                                    @error('icon')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tag" id="lbl_tag" class="form-control"
                                        value="{{ old('tag', $data->tag) }}" placeholder="{{ __('common.lbl_tag') }}">
                                    @error('tag')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="checkbox checkbox-success checkbox-circle mb-2">
                                        <input id="lbl_active" name="active" type="checkbox"
                                            {{ old('active', $data->active) == ACTIVE_SHOW ? 'checked' : '' }}
                                            value="{{ ACTIVE_SHOW }}">
