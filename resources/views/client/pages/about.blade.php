    ...
    <div class="container mt-2 mb-2 pb-5" id="article-grid">
        <div class="row justify-content-center">
            <div class="col-md-3 col-sm-6 text-center">
                <style>@media and (max-width: 1200px) and (min-width: 768px) {.article-img-author {height: 160px !important;}}</style>
            ...
            <div class="col-md-6 mt-md-5 mt-sm-3">
                ...
                <p>I'm a website developer. Specialize in PHP/Laravel back-end development, but also have experience with
                    ...
                    <i>You can view detail<a href="https://hioncoding.com/public/common/VO_CHI_LONG-CV_PHP.pdf" target="_blank" rel="nofollow"> <b>My CV in Here</b> 🎉</a> or <b>short detail below</b></i>
                </p>
                <hr>
                <b>Skills</b>
