...
<head>
    ...
    <title>Hion Coding - Inquiry Email Template</title>
    <meta name="description" content="Hion Coding - Inquiry Email Template">
</head>
<style>
    a:hover {
                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://hioncoding.com/" title="logo" target="_blank">
                                <img width="60" src="https://hioncoding.com/common/images/logo.png" title="logo"
                                    alt="logo">
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0;">&copy;
                                <strong>https://hioncoding.com</strong>
                            </p>
                        </td>
                    </tr>
                </table>
